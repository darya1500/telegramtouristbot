...
public class StartCommand implements BasicCommand {
    ...
    public String  execute() {
        return "Здравствуйте! TelegramTouristBot приветствует Вас! Я помогу Вам найти достопримечательности " +
...
//    public StartCityCommand(CityService service) {
